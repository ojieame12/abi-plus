...
const mockComments: Record<string, Comment[]> = {
  ...
  'a_001': [
    { id: 'c1', author: { id: 'u1', displayName: 'Alex Turner', avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face', reputation: 890 }, body: 'Great explanation! The triangulation approach makes a lot of sense.', likes: 5, createdAt: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString() },
    { id: 'c2', author: { id: 'u2', displayName: 'Sarah Chen', reputation: 1850 }, body: 'Would the local credit bureaus work for suppliers in Vietnam specifically?', likes: 2, createdAt: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString() },
  ...
  'a_002': [
    { id: 'c3', author: { id: 'u3', displayName: 'Mike Ross', avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face', reputation: 560 }, body: 'Thanks for the detailed breakdown! Never thought of using insurers as an intel source.', likes: 3, createdAt: new Date(Date.now() - 30 * 60 * 1000).toISOString() },
  ],
  ...
  'a_003': [
    ...
    { id: 'c5', author: { id: 'u5', displayName: 'David Park', reputation: 678 }, body: '@Jennifer we position it as mutual transparency - we share our forecast data too.', likes: 6, createdAt: new Date(Date.now() - 15 * 60 * 1000).toISOString() },
  ],
  // Comments for answer a_004 (Emily Watson's answer about single-source risk)
  'a_004': [
    { id: 'c7', author: { id: 'u7', displayName: 'Tom Bradley', reputation: 920 }, body: 'The "insurance value" calculation is brilliant. Do you have a template for that?', likes: 7, createdAt: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString() },
  ],
  // Comments for answer a_005 (Michael Torres's answer about EcoVadis)
  'a_005': [
    { id: 'c8', author: { id: 'u8', displayName: 'Lisa Wang', avatarUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=100&h=100&fit=crop&crop=face', reputation: 1540 }, body: 'Have you compared EcoVadis with Sedex? We use both and wondering if we can consolidate.', likes: 3, createdAt: new Date(Date.now() - 5 * 60 * 60 * 1000).toISOString() },
  ],
  ...
  'a_015': [
    ...
    { id: 'c12', author: { id: 'u12', displayName: 'Amanda Rodriguez', avatarUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=100&h=100&fit=crop&crop=face', reputation: 1534 }, body: 'Adding one more: check if their quality records match their shipping records. Discrepancies = data manipulation.', likes: 15, createdAt: new Date(Date.now() - 20 * 60 * 60 * 1000).toISOString() },
  ],
};
