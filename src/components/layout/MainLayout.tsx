...
export const MainLayout = ({
    ...
    return (
        <div className="flex w-full h-screen bg-white overflow-hidden font-sans p-2 gap-1.5">
            ...
            {/* Column 2: Main Content - Inset panel effect */}
            <main className="flex-1 h-full min-w-0 flex flex-col relative z-0">
            ...
            {/* Column 3: Artifact Panel (conditional, part of flex flow) */}
            {panel}
        </div>
    );
};
